{
  "connection": {
    "cli": {
      "arguments": [
        [
          ...
          "admin",
          "--host",
          "2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud:30756"
        ]
      ],
      "bin": "db2",
      "certificate": {
      ...
      "composed": [
        "db2 -u ngd26913 -p hiyUFEnKEJUxGvS4 --ssl --sslCAFile 2ce1ab40-7379-45d8-a40c-38dcafaf95d0 --authenticationDatabase admin --host 2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud:30756"
      ],
      "environment": {},
      "type": "cli"
    },
    "db2": {
      ...
      "composed": [
        "db2://ngd26913:hiyUFEnKEJUxGvS4@2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud:30756/bludb?authSource=admin&replicaSet=replset"
      ],
      "database": "bludb",
      "host_ros": [
        "2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud:31458"
      ],
      "hosts": [
        {
      ...
      "jdbc_url": [
        "jdbc:db2://2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud:30756/bludb:user=<userid>;password=<your_password>;sslConnection=true;"
      ],
      "path": "/bludb",
      "query_options": {
        "authSource": "admin",
  ...
  "instance_administration_api": {
    "deployment_id": "crn:v1:bluemix:public:dashdb-for-transactions:us-south:a/2bd32c4e8127447783a4a1af586a58ed:fa560b9a-8145-46a2-ab07-40425dbb98a3::",
    "instance_id": "crn:v1:bluemix:public:dashdb-for-transactions:us-south:a/2bd32c4e8127447783a4a1af586a58ed:fa560b9a-8145-46a2-ab07-40425dbb98a3::",
